...
class Magestore_Magenotification_Adminhtml_Magestore_Notification_FeedbackController extends Mage_Adminhtml_Controller_Action
{
        ...
        public function editAction(){
                ...
                if ($model->getId() || $id == 0) {
                        ...
                        $this->_addContent($this->getLayout()->createBlock('adminhtml/magestore_notification_feedback_edit'))
                                ->_addLeft($this->getLayout()->createBlock('adminhtml/magestore_notification_feedback_edit_tabs'));
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('adminhtml/magestore_notification_feedback_grid')
            ->getCsv();
