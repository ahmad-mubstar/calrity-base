...
class Magestore_Magenotification_Adminhtml_Magestore_Notification_MagenotificationController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction(){
        ...
        $this->loadLayout()
            ...
            ->_addContent($this->getLayout()->createBlock('adminhtml/magestore_notification_notification_inbox'))
            //->_addContent($this->getLayout()->createBlock('adminhtml/magestore_notification_notification_inbox_grid'))
            ->renderLayout();
    }
