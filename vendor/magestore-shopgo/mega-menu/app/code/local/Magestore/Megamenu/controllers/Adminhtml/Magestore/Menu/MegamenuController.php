...
class Magestore_Megamenu_Adminhtml_Magestore_Menu_MegamenuController extends Mage_Adminhtml_Controller_Action {
...
//         }
    ...
    public function setDataDefault($data) {
        if ($data['hide']) {
            ...
            if (!isset($data['border_size']))
                if(isset($data['border_size_default']) && $data['border_size_default'])
    ...
    protected function _isAllowed() {
        //return true;
        if ($this->getRequest()->getActionName() == "cache") {
            // isalem 6/12/2017
            //return Mage::getSingleton('admin/session')->isAllowed('admin/megamenu/template'); // note admin/pdfadmin_menu from file: adminhtml.xml
            return Mage::getSingleton('admin/session')->isAllowed('admin/catalog/categories/categories'); // note admin/pdfadmin_menu from file: adminhtml.xml
        } else {
            // isalem 6/12/2017
            //return Mage::getSingleton('admin/session')->isAllowed('admin/megamenu/megamenu'); // note admin/pdfadmin_menu from file: adminhtml.xml
            return Mage::getSingleton('admin/session')->isAllowed('admin/catalog/categories/categories'); // note admin/pdfadmin_menu from file: adminhtml.xml
        }
    }
