...
class Magestore_Megamenu_Block_Item extends Mage_Core_Block_Template {
    ...
    {
        return Mage::getBlockSingleton('catalog/product_price')
            ->getPriceHtml($product, $displayMinimalPrice, $idSuffix);
    }
    ...
    public function getCategoryTree($category = null) {
        if (empty($category)) {
        ...
        } elseif (gettype($category) != 'object') {
            return null;
        }
