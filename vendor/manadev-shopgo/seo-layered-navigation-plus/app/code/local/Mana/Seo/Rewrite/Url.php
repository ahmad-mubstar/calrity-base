                    ...
                    if ($url = $this->_getParameterUrl($key)) {
                        ...
                        switch ($url->getType()) {
                            case Mana_Seo_Model_ParsedUrl::PARAMETER_ATTRIBUTE:
                                // Handle aheadWorks Shop By Brand key values
                                if (class_exists('Mana_Filters_Helper_Awshopbybrand')) {
                                    $value = Mage::helper('mana_filters/awshopbybrand')->handleRoutePathKey($this->_query, $key, $value);
                                    if ($value === false) {
                                        continue;
                                    }
                                }
