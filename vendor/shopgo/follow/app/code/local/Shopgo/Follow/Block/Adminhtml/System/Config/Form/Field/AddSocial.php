<?php
class Shopgo_Follow_Block_Adminhtml_System_Config_Form_Field_AddSocial extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    public function __construct()
    {
        if (!$this->getTemplate()) {
            $this->setTemplate('shopgo/follow/system/config/form/field/array.phtml');
        }
        ...
        $this->addColumn('color', array(
            'label' => Mage::helper('adminhtml')->__('Color'),
            'style' => 'width: 65px',
            'type' => 'input',
            'class' => 'minicolor input-text'
        ));
