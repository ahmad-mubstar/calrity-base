...
class Shopgo_StyleEditor_Block_Adminhtml_System_Config_Styleeditor_Button extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /*
     * Set template
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('shopgo/styleeditor/system/config/styleeditor/button.phtml');
    }
