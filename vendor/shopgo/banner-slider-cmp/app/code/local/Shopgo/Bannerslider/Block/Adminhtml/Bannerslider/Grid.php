<?php
class Shopgo_Bannerslider_Block_Adminhtml_Bannerslider_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('bannersliderGrid');
      $this->setDefaultSort('bs_id');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('identifier', array(
          'header'    => Mage::helper('bannerslider')->__('Identifier'),
          'align'     =>'left',
          'index'     => 'identifier',
      ));
    ...
    {
        $this->setMassactionIdField('bs_id');
