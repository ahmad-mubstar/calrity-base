    ...
    extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed() {
        //isalem 6/12/2017
        //return Mage::getSingleton('admin/session')->isAllowed('admin/shopgo/shippingcore/aramex/supplier');
        return Mage::getSingleton('admin/session')->isAllowed('admin/system/store/shipping/aramex/supplier');
    }
}
