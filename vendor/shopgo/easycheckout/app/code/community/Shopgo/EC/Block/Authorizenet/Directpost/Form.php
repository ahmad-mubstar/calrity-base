 ...
 */
class Shopgo_EC_Block_Authorizenet_Directpost_Form extends Mage_Authorizenet_Block_Directpost_Form
{
    /**
    ...
    {
        parent::_construct();
        $this->setTemplate('shopgo/ec/authorizenet/directpost/info.phtml');
    }
