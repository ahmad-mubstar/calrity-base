...
class Shopgo_Geo_Model_Abstract
{
	...
	//changed by Ahmad Rasmi
        // $this->remote_archive = 'https://shopgo.me/GeoIP.dat.gz';
	$this->remote_archive =  'http://' . $_SERVER['SERVER_NAME'] . '/GeoIP.dat.gz';
        //this works too $this->remote_archive = 'https://src.fedoraproject.org/lookaside/pkgs/geoip-geolite/GeoIP.dat.gz/9701baf889726eaed768d8aa7ad8243d/GeoIP.dat.gz';
    }
