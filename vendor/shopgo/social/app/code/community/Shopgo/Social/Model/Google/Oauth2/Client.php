...
class Shopgo_Social_Model_Google_Oauth2_Client
{
    const REDIRECT_URI_ROUTE = 'social/google/connect';

    const XML_PATH_ENABLED = 'social/google/enabled';
    const XML_PATH_CLIENT_ID = 'social/google/client_id';
    const XML_PATH_CLIENT_SECRET = 'social/google/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Shopgo_Social_Model_Google_Oauth2_Exception($message);
            } else {
                $message = sprintf(
                    Mage::helper('shopgo_social')
