...
class Shopgo_Social_Model_Facebook_Oauth2_Client
{
    const REDIRECT_URI_ROUTE = 'social/facebook/connect';

    const XML_PATH_ENABLED = 'social/facebook/enabled';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Shopgo_Social_Model_Facebook_Oauth2_Exception($message);
            } else {
                $message = sprintf(
                    Mage::helper('shopgo_social')
