...
class Shopgo_Social_Block_Register extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('shopgo_social_button_text', $this->__('Register'), true);

        $this->setTemplate('shopgo/social/register.phtml');
    }
