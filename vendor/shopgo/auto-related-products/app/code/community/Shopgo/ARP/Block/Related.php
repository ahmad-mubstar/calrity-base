...
class Shopgo_ARP_Block_Related extends Mage_Catalog_Block_Product_List_Related
{
	protected function _construct() {
		// Only cache if we have something thats keyable..
		$_time = (int)Mage::getStoreConfig('arp/general/cache_lifetime');
	...
	protected function _prepareData (){
		...
		if ($_enabled && count($this->getItems()) == 0){
			$_products = Mage::getModel('arp/collection')->getRelatedProducts();
			if ($_products){
