<?php
class Shopgo_ARP_Block_Adminhtml_Catalog_Product_Edit_Tab_Related extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Related
{
	/**
	...
	{
		$_enabled = Mage::getStoreConfig('arp/general/enabled');
		if(!$_enabled)
			return parent::getSelectedRelatedProducts();
		
		$_backend_enabled = Mage::getStoreConfig('arp/general/backend_enabled');
		if(!$_backend_enabled)
			return parent::getSelectedRelatedProducts();
