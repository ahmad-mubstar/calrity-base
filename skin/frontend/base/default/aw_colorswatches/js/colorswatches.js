            ...
            if (this.currentInfo.id != newId) {
                ...
                try {
                    if (!this.productImage) {
                        this.productImage = $$('.product-img-box')[0];
                ...
                try {
                    if (!this.productPrice) {
                        this.productPrice = $$('.product-options-bottom .price-box .regular-price')[0].getElementsByClassName('price')[0];
                        this.defaultInfo.productPrice = this.productPrice.innerHTML;
                    }
                } catch (e) {
                }
                try {
                ...
                try {
                    ...
                    if (info.price) {
                        ...
                        newPrice = this.defaultInfo.price;
                    }
                    if (this.productPrice) {
                        this.productPrice.innerHTML = newPrice;
                    }
...
function mediainit(){
    ...
    jQuery('.sxzoom').swinxyzoom({mode:'window',size: '100%',  controls: 0});
}