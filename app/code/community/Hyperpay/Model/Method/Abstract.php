...
abstract class Hyperpay_Model_Method_Abstract extends Mage_Payment_Model_Method_Abstract
{
    ...
    {
        $credentials = array(
            'userId'      => Mage::getStoreConfig('payment/hyperpay/userId', $this->getOrder()->getStoreId()),
            'entityId'  => Mage::getStoreConfig('payment/' . $this->getCode() . '/entityId', $this->getOrder()->getStoreId()),
            'password'    => Mage::getStoreConfig('payment/hyperpay/password', $this->getOrder()->getStoreId())
        );
        return $credentials;
    }
    ...
    public function getOrderPlaceRedirectUrl()
    {
        ...
        $token = getToken($postData,$url,$server)['id'];
