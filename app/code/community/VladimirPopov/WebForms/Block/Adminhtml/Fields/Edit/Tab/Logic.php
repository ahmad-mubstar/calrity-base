    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('adminhtml/logic/grid', array('id' => $this->getRequest()->getParam('id'), 'store' => $this->getRequest()->getParam('store')));
    }

    public function getRowUrl($row)
    {
        return $this->getUrl('adminhtml/logic/edit', array('id' => $row->getId(), 'store' => $this->getRequest()->getParam('store')));
    }
