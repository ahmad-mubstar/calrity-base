	...
	extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function __construct()
	{
        ...
        (
            ...
            'class' => 'save',
            'onclick' => 'setLocation(\'' . $this->getUrl('adminhtml/print_result/print',array('_current'=>true,'result_id' => $result->getId())) . '\')',
        ));
	...
	{
		return $this->getUrl('adminhtml/results/save');
	}
	
	public function getBackUrl(){
		return $this->getUrl('adminhtml/results/index',array('webform_id'=>Mage::registry('result')->getWebformId()));
	}
