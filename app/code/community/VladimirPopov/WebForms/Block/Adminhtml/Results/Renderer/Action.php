	...
	extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	...
	{
		$edit_href = $this->getUrl('adminhtml/results/edit', array('_current'=>false,'id'=>$row->getId()));
		$reply_href = $this->getUrl('adminhtml/results/reply', array('_current'=>true,'id'=>$row->getId()));
        $print_href = $this->getUrl('adminhtml/print_result/print',array('result_id'=>$row->getId()));
