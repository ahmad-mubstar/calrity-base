	...
	extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	public function getGridUrl(){
		return $this->getUrl('adminhtml/fields/grid',array('id'=> $this->getRequest()->getParam('id'),'store'=>$this->getRequest()->getParam('store')));
	}
	
	public function getRowUrl($row){
		return $this->getUrl('adminhtml/fields/edit', array('id' => $row->getId(), 'webform_id' => $this->getRequest()->getParam('id'), 'store' => $this->getRequest()->getParam('store')));
	}
	...
	protected function _prepareMassaction()
	{
		...
		$this->getMassactionBlock()->addItem('delete', array(
			 ...
			 'url'  => $this->getUrl('adminhtml/fields/massDelete', array('webform_id' => $this->getParam('id'))),
		...
		$this->getMassactionBlock()->addItem('status', array(
			 ...
			 'url'  => $this->getUrl('adminhtml/fields/massStatus', array('webform_id' => $this->getParam('id'),'store'=>$this->getRequest()->getParam('store'))),
			 'additional' => array(
					'visibility' => array(
						 'name' => 'status',
						 'type' => 'select',
		...
		if(count($fieldsetsOptions)>1) {
			$this->getMassactionBlock()->addItem('fieldset', array(
				 ...
				 'url'  => $this->getUrl('adminhtml/fields/massFieldset', array('webform_id' => $this->getParam('id'),'store'=>$this->getRequest()->getParam('store'))),
				 'additional' => array(
						'visibility' => array(
							 'name' => 'fieldset',
							 'type' => 'select',
		...
		$this->getMassactionBlock()->addItem('duplicate', array(
			 ...
			 'url'  => $this->getUrl('adminhtml/fields/massDuplicate', array('webform_id' => $this->getParam('id'))),
