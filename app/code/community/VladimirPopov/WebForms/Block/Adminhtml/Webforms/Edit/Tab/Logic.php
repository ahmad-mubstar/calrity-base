    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('adminhtml/webforms/logic', array('webform_id' => $this->getRequest()->getParam('id'), 'store' => $this->getRequest()->getParam('store')));
    }

    public function getRowUrl($row)
    {
        return $this->getUrl('adminhtml/logic/edit', array('id' => $row->getId(), 'webform_id' => $this->getRequest()->getParam('id'), 'store' => $this->getRequest()->getParam('store')));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            ...
            'url' => $this->getUrl('adminhtml/logic/massDelete', array(
        ...
        $this->getMassactionBlock()->addItem('status', array(
            ...
            'url' => $this->getUrl('adminhtml/logic/massStatus', array(
                'webform_id' => $this->getRequest()->getParam('id'),
                'store' => $this->getRequest()->getParam('store'))),
            'additional' => array(
                'visibility' => array(
