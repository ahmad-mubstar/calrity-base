...
class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
{
    ...
    {
        // isalem 24/12/2017
        // removed this line and added the rest (based on other smilir actions - see EC)
    ...
    public function savePaymentAction()
    {
        ...
        try {
            ...
            if (empty($result['error']) && !$redirectUrl) {
                // isalem 24/12/2017 .. was causing exception
                // based on other smiliar actions, this line doesn;t exist .. so I removed it
