...
class Mage_Adminhtml_Catalog_Product_ReviewController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_setActiveMenu('promo/cauc/reviews_ratings/reviews/all');
    ...
    public function pendingAction()
    {
        ...
        // isalem 1/12/2017
        // $this->_setActiveMenu('catalog/review');
        $this->_setActiveMenu('promo/cauc/reviews_ratings/reviews/pending');
    ...
    protected function _isAllowed()
    {
        ...
        switch ($action) {
            case 'pending':
                return Mage::getSingleton('admin/session')->isAllowed('admin/promo/cauc/reviews_ratings/reviews/pending');
            ...
            default:
                ...
                return Mage::getSingleton('admin/session')->isAllowed('admin/promo/cauc/reviews_ratings/reviews/all');
                break;
        }
    }
}
