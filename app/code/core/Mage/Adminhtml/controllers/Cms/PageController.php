...
class Mage_Adminhtml_Cms_PageController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        ...
        switch ($action) {
            case 'new':
            case 'save':
                return Mage::getSingleton('admin/session')->isAllowed('cms/cms/page/save');
                break;
            case 'delete':
                return Mage::getSingleton('admin/session')->isAllowed('cms/cms/page/delete');
                break;
            default:
                return Mage::getSingleton('admin/session')->isAllowed('cms/cms/page');
                break;
        }
    }
