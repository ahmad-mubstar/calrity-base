 ...
 *
*/
class Glace_Booking_Model_Product_Type_Booking_Price
extends Mage_Catalog_Model_Product_Type_Price
{
	/**
	 * Multidate Group Instance
	 *
	 * @var Glace_Booking_Model_Catalog_Product_Option_Type_Multidate
	 */
		...
		if ($optionIds = $product->getCustomOption('option_ids')) {
			...
			foreach (explode(',', $optionIds->getValue()) as $optionId) {
				if ($option = $product->getOptionById($optionId)) {
					...
					if($group instanceof Glace_Booking_Model_Catalog_Product_Option_Type_Multidate)
					{
