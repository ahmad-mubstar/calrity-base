 ...
 *
*/
class Glace_Booking_Block_Adminhtml_Book_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		...
		$collection = Mage::getResourceModel('booking/book_item_collection')
		->join(array('p' => 'catalog/product'), 'main_table.product_id = p.entity_id', array(
				'Sku' => 'sku',
		))
		->join(array('b' => 'booking/book'), 'main_table.book_id = b.book_id', array(
